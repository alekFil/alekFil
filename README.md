## Привет, я Алексей 👋 - Data Scientist с годом опыта работы
...
| - |:------------------------------------------------------------------ |:-------------------------------------:| -------------------------------------------------------- |
| 1 | [Samokat.tech](https://github.com/alekFil/Samokat.tech-Matching)   | `Python`, `Scikit-Learn`, `CatBoost`  | Задача мэтчинга/классификации от Samokat.tech            |

### Расширенные учебные проекты

| № | Название проекта                                         | Инструменты                           | Краткое описание                                         |
| - |:-------------------------------------------------------- |:-------------------------------------:| -------------------------------------------------------- |
| 1 | [Спрос такси](https://github.com/alekFil/edu_timeseries) | `Python`, `Scikit-Learn`, `CatBoost`  | Задача прогнозирования временных рядов                   |
